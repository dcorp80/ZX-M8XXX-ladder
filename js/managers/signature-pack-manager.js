// Signature Pack Manager — modular knowledge base for automatic label/region recognition
// Extracted from index.html v0.9.31
...
export class SignaturePackManager {
    ...
    // Inject assembler dependencies (called after construction)
