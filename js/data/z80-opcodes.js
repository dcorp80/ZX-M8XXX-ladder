// Extracted from index.html inline script, lines 9365-9975
// Z80 opcode reference data and filter/render functions

// Complete Z80 opcode reference table
// Each entry: m=mnemonic, o=opcode hex, b=bytes, c=cycles, f=flags, d=description, g=group, u=undocumented
const z80Opcodes = [
    // Load 8-bit
...
// Render opcodes into a <tbody> element
// Lines 9908-9941
export function renderOpcodes(filter = '', group = 'all', cycles = 'all', sortBy = 'mnemonic') {
...
// Lines 9958-9965
export function getOpcodeFilters() {
    return {
...
// Lines 9967-9970
export function applyOpcodeFilters() {
