...
**Version 0.9.37** | [Changelog](CHANGELOG-original.md)

ZX-M8XXX (ZX Matrix) is a vanilla JavaScript ZX Spectrum emulator with an integrated debugger designed for reverse engineering and development. Uses Vite for bundling and pako as a dependency.
...
1. Install dependencies:
   ...
   npm install
   ```
2. Place ROM files in `roms/` directory:
...
3. Start the dev server:
   ...
   npm run dev
   ```
4. Click **Help** button for comprehensive documentation
...
![Debugger View](main_1.png)

![Graphics Viewer](main_2.png)

### Games

<p>
<img src="screenshot_academy.png" width="49%">&nbsp;<img src="screenshot_aquaplane.png" width="49%">
</p>
<p>
<img src="screenshot_comet_game.png" width="49%">&nbsp;<img src="screenshot_shock.png" width="49%">
</p>
<p>
<img src="screenshot_venom.png" width="49%">&nbsp;<img src="screenshot_yazzie.png" width="49%">
</p>
