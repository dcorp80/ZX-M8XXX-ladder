...
import { getMachineProfile, is128kCompat } from '../machines/profiles';
import {
    SCREEN_ATTR, SCREEN_END,
    PORT_7FFD, PORT_1FFD, PORT_EFF7,
    PORT_AY_REG, PORT_AY_DATA,
    PORT_ULAPLUS_DATA, PORT_ULAPLUS_REG,
    ...
    PAGE_SIZE, SNA_HEADER_SIZE, SNA_48K_SIZE, SNA_128K_SIZE
} from './constants';
import { Memory } from './memory/memory';
import { Z80 } from './cpu/z80';
import { ULA } from '../devices/ula/ula';
import { AY } from '../devices/audio/ay';
import {
...
export class Spectrum {
    ...
    evaluateCondition(condition: any, context: any = {}) {
    ...
    rzxVerifyRecording() {
        ...
        try {
            const hex = (arr: any, start: number, len: number) => Array.from(arr.slice(start, start + len) as number[])
